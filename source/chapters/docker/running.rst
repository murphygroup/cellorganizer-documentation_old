...
* Use the build script to create the image ( you will need the matlab of cellorganizer or it will download the latest from web)
* Once the image builds successfully ( docker images command can be used to check if image is created)
* Use the run script to run the conatiner with this image